    ...
    public partial class First : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GuestResponses", x => x.GuestResponseId);
                    table.ForeignKey(
                        name: "FK_GuestResponses_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "UserId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GuestResponses_Weddings_WeddingId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GuestResponses_UserId",
                table: "GuestResponses",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_GuestResponses_WeddingId",
                table: "GuestResponses",
                column: "WeddingId");
